...
sealed interface ControlMessage {
    ...
    data class JoinChannel(val channelId: String, val nickname: String, val userId: String) : ControlMessage

    @Serializable
    @SerialName("leave_channel")
    data class LeaveChannel(val channelId: String, val userId: String) : ControlMessage

    @Serializable
    @SerialName("start_speaking")
    data class StartSpeaking(val channelId: String, val userId: String) : ControlMessage

    @Serializable
    @SerialName("stop_speaking")
    data class StopSpeaking(val channelId: String, val userId: String) : ControlMessage
    ...
    data class Heartbeat(val userId: String) : ControlMessage
}

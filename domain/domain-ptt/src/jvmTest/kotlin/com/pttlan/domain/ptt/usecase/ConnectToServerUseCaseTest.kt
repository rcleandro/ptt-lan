...
class ConnectToServerUseCaseTest {
    ...
    @Test
    fun `invoke should return failure when nickname is blank`() = runTest {
    ...
    @Test
    fun `invoke should call repository connect when nickname is valid`() = runTest {
    ...
    @Test
    fun `invoke should return repository failure when connect fails`() = runTest {
        val host = "192.168.0.1"
        val port = 8080
        val nickname = "User1"
